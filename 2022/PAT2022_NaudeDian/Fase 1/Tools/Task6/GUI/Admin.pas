...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, Vcl.DBCtrls, Vcl.WinXPickers;
...
type
  TfrmAdmin = class(TForm)
    ...
    btnScore: TButton;
    menAdmin: TMainMenu;
    btnLeaderBoard: TMenuItem;
    btnOldestPlayer: TMenuItem;
    btnYoungestPlayer: TMenuItem;
    btnSearchPlayer: TMenuItem;
    btnAverageAgeofPlater: TMenuItem;
    ...
    sedPlayerA: TSpinEdit;
    tpGameA: TTimePicker;
    BtnScheduleA: TButton;
    lblSMADmin: TLabel;
    sedPlayerB: TSpinEdit;
    lblPlayerB: TLabel;
    btnUpdatePlayerL: TButton;
...
sName :string;
begin
sName := InputBox('Enter new users name','User name:','Ben')  ;
...
for i := 2 to 10 do
  begin
    sI := inttostr(i);
    Pengiun := inttostr(dmDataA.tblScoreM[sI]);
    ShowMessage(Pengiun);
  end;
