 ...
 begin
   ...
   ShowMessage('Player removed');
    ...
    begin
     ...
     frmlogin.iCounterarray:= 0;
     AssignFile(frmLogin.tFileUP,'UsernamePass.txt');
     Reset(frmLogin.tFileUP);
      while not eof(frmLogin.tFileUP) do
     begin
     inc(frmLogin.iCounterArray) ;
     Readln(frmLogin.tFileUP, sOutcome);
     ...
     Delete(sOutcome,1,ipos);
     frmLogin.arrUsername[frmLogin.iCounterArray] := sUser;
     frmLogin.arrPassword[frmLogin.iCounterArray] := sPass;


     end;
     CloseFile(frmLogin.tFileUP);
     end
     else
     begin
